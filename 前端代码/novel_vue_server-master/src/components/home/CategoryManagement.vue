<template>
  <div>
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" @click="postCategoryFirst">新增</el-button>
      </el-form-item>
    </el-form>
...
<!--          <el-button type="primary" @click="$router.push({path: '/home/categoryFirst',query: {id: scope.row.id}})">查看</el-button>-->
          <el-button type="primary" @click="dialogVisible = true;dialogCategoryId = scope.row.id;dialogCategoryName = scope.row.name;">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
