        ...
        <el-row>
          <el-col :span="16" :offset="4">
            <el-form ref="form" :model="formData" label-width="100px">
              ...
              <el-form-item>
                <el-button type="primary" @click="postNovel">新增小说</el-button>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="16" :offset="4">
            <el-form :inline="true" class="demo-form-inline">
              ...
              <el-form-item>
                <el-button type="primary" @click="getNovel">查询</el-button>
              </el-form-item>
            </el-form>
          </el-col>
        </el-row>
        <el-table :data="novelList" style="width: 100%">
          ...
          <el-table-column fixed="right" label="操作"  style="width: 25%">
            <template slot-scope="scope">
              <el-button type="primary" @click="$router.push({path: '/home/novel',query: {id: scope.row.id}})">查看</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-tab-pane>
