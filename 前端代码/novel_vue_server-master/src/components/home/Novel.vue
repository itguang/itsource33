<template>
  <div>
    ...
    <el-row>
      <el-col :span="10">
        <el-row>
          ...
          <el-col :span="8"><el-button type="text" @click="dialogVisibleOfImage = true;">修改封面</el-button></el-col>
        </el-row>
      </el-col>
      <el-col :span="14">
        <el-row>
          <el-col :span="16"><h2>小说名称：{{novel.name}}</h2></el-col>
          <el-col :span="8"><el-button type="text" @click="dialogVisibleOfName = true;dialogDataOfName = novel.name">修改小说名</el-button></el-col>
        </el-row>
        <el-row>
          <el-col :span="16">小说概述：{{novel.summary}}</el-col>
          <el-col :span="8"><el-button type="text" @click="dialogVisibleOfSummary = true;dialogDataOfSummary = novel.summary">修改</el-button></el-col>
        </el-row>
        <el-row>
          <el-col :span="16">小说分类：{{parentCategoryName}}-{{categoryName}}</el-col>
          <el-col :span="8"><el-button type="text" @click="dialogVisibleOfCategory_id = true">修改</el-button></el-col>
        </el-row>
        <el-row>
          <el-col :span="16">推荐系数：{{novel.multiplier}}</el-col>
          <el-col :span="8"><el-button type="text" @click="dialogVisibleOfMultiplier = true;dialogDataOfMultiplier = novel.multiplier">修改</el-button></el-col>
        </el-row>
        <el-row>
          <el-col :span="16">推荐常数：{{novel.addend}}</el-col>
          <el-col :span="8"><el-button type="text" @click="dialogVisibleOfAddend = true;dialogDataOfAddend = novel.addend">修改</el-button></el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-button type = "success" v-if="!hasRecommended" @click="postRecommend">推荐</el-button>
    ...
    <el-form ref="form" label-width="80px">
      ...
      <el-form-item>
        <el-button type="primary" @click="postVolume">立即创建</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="volumeList" style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作"  style="width: 34%">
        <template slot-scope="scope">
          <el-button type="primary" @click="$router.push({path:'/home/volume',query: {id:scope.row.id}})">查看</el-button>
          <el-button type="primary"  @click="dialogVisibleOfNameOfVolume = true;dialogDataOfIdOfVolume = scope.row.id;dialogDataOfNameOfVolume = scope.row.name;">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
