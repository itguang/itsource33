      ...
      <el-col :span="8" :offset="8">
        <el-row :gutter="20">
          ...
          <el-col :span="16">
            ...
            <el-col>
              <el-button type="text" v-if="!hasCollected" @click="postCollection"  :style="{ color: '#67C23A' }">收藏</el-button>
              <el-button type="text" v-else @click="deleteCollection">取消收藏</el-button>
              <el-button type="text" v-if="!hasRecommended" @click="postRecommend" :style="{ color: '#67C23A' }">推荐</el-button>
              <el-button type="text" v-else @click="deleteRecommend">取消推荐</el-button>
            </el-col>
          </el-col>
        </el-row>
      </el-col>
